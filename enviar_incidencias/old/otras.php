...
?>
	...
	<div class="blogbody">
		...
		<div class="big">
				[ Otras incidencias ]<br><br>
		</div>			
			<FORM NAME=frmotras ACTION="otras_enviada.php" METHOD="POST" enctype="multipart/form-data"> 
		...
		<script type="text/javascript">
				...
				<DIV ALIGN=RIGHT>
					<INPUT NAME="Enviar" VALUE="Enviar incidencia" TYPE=BUTTON onclick="submit_final_otras();" >
				</DIV>
				</FORM></div>			<BR>
