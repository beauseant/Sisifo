...
function print_login() {
    ...
    echo '
        <form action="' . $baseurl . '/index.php" method=POST name="loginform">
                <div class="pantallaini">
                        <div class="pintalogin">
                                <br>
                                usuario:  <input type=text name="ulogin" size=15>
                                <br>
                                contrase&ntilde;a:    <input type="password" name="password" size=15>
                                <br><br>
                                <input type="hidden" name="act" value="login">
                                <input class="search" type="submit" value="::entrar::">
                        </div>
                </div>

                <script type="text/javascript">
                        loginform.ulogin.focus();
                </script>
          </form>
        <br><br><br>
     ';
...
<?php  $d = 1;
    ...
    $firstweek = true;
	 ...
	 while ( $d <= $lastday)
	 {
	   ...
	   $db = $sisifoConf -> getBd();
	   $sql = "select count(*) as count from incidencia where id_usuario = $userid AND fecha_llegada like '$y-$mo-$da%'";
	   $res = $db->Execute($sql);
...
<b><a href="archivo.php?m=<?=$pm?>&y=<?=(($m-1)<1) ? $y-1 : $y ?>"><?=getPrevMo($mo);?></a></b>
</td><td><br></td>
<td colspan=3 align=left><b><a href="archivo.php?m=<?=$nm?>&y=<?=(($m+1)>12) ? $y+1 : $y ?>"><?=getNextMo($mo);?></b></a></td></tr>
</table>
